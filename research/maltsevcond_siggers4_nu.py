...
ALGS3 = [
    ...
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 1, 0, 0, 2, 0, 1, 1, 1,
                         1, 1, 2, 1, 2, 0, 0, 2, 2, 1, 2, 2, 2, 2]),
        PartialOp(3, 0, [0]),
        PartialOp(3, 0, [1]),
        PartialOp(3, 0, [2]),
    ]),
    ...
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 1, 0, 2, 2, 0, 1, 2, 1,
                         1, 1, 1, 1, 2, 0, 2, 2, 0, 1, 2, 2, 2, 2]),
        PartialOp(3, 0, [0]),
        PartialOp(3, 0, [1]),
        PartialOp(3, 0, [2]),
    ]),
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 2, 0, 0, 2, 0, 1, 1, 1,
    ...
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 0, 0, 0, 2, 0, 1, 0, 1,
                         1, 1, 1, 1, 2, 0, 2, 2, 0, 1, 2, 2, 2, 2]),
        PartialOp(3, 0, [0]),
        PartialOp(3, 0, [1]),
        PartialOp(3, 0, [2]),
    ...
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 2, 0, 1, 2, 0, 1, 1, 1,
                         1, 1, 2, 1, 2, 0, 1, 2, 0, 1, 2, 2, 2, 2]),
        PartialOp(3, 0, [0]),
        PartialOp(3, 0, [1]),
        PartialOp(3, 0, [2]),
    ]),
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 1, 0, 1, 2, 0, 1, 2, 1,
                         1, 1, 2, 1, 2, 0, 2, 2, 2, 1, 2, 2, 2, 2]),
        PartialOp(3, 0, [0]),
        PartialOp(3, 0, [1]),
        PartialOp(3, 0, [2]),
    ]),
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 2, 0, 2, 2, 0, 1, 1, 1,
                         1, 1, 0, 1, 2, 0, 1, 2, 2, 1, 2, 2, 2, 2]),
        PartialOp(3, 0, [0]),
        PartialOp(3, 0, [1]),
        PartialOp(3, 0, [2]),
    ]),
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 1, 0, 1, 2, 0, 1, 1, 1,
                         1, 1, 2, 1, 2, 0, 2, 2, 1, 1, 2, 2, 2, 2]),
        PartialOp(3, 0, [0]),
        PartialOp(3, 0, [1]),
        PartialOp(3, 0, [2]),
    ]),
    ...
    SmallAlg([
        PartialOp(3, 3, [0, 0, 0, 0, 1, 2, 0, 0, 2, 0, 1, 1, 1,
                         1, 1, 0, 1, 2, 0, 2, 2, 1, 1, 2, 2, 2, 2]),
        PartialOp(3, 0, [0]),
        PartialOp(3, 0, [1]),
        PartialOp(3, 0, [2]),
    ]),
    SmallAlg([
        PartialOp(4, 3, [0, 0, 0, 0, 0, 1, 3, 2, 0, 2, 2, 2, 0, 2, 0, 3, 0, 1, 3, 3, 1, 1, 1, 1, 3, 1, 2, 2, 3, 1,
                         0, 3, 0, 3, 2, 0, 3, 1, 2, 1, 2, 2, 2, 2, 0, 1, 2, 3, 0, 2, 0, 3, 3, 1, 2, 3, 0, 1, 2, 3, 3, 3, 3, 3]),
        PartialOp(4, 0, [0]),
        PartialOp(4, 0, [1]),
        PartialOp(4, 0, [2]),
    ]),
...
def test1():
    ...
    while True:
        ...
        alg = find_algebra(5, (0, 1, 2), arity, multi_steps)
        if alg is None:
            break
