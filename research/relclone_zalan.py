...
from uasat.conditions import MajorityCond, MaltsevCond, SiggersCond, FindAllMinConds
from typing import List


def minimal_majority3():
    finder = FindAllMinConds(3, MajorityCond(), debug=True)
...
def minimal_maltsev3():
    finder = FindAllMinConds(3, MaltsevCond(), debug=True)
    finder.find_minimal_conditions(3)
    finder.print_result()


def minimal_siggers2():
    finder = FindAllMinConds(2, SiggersCond(), debug=True)
    finder.find_minimal_conditions(3)
    finder.print_result()


def minimal_siggers3():
    finder = FindAllMinConds(3, SiggersCond(), debug=True)
    finder.find_minimal_conditions(3)
    finder.print_result()
